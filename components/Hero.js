  ...
  return (
    <section>
      <div className="max-w-3xl 2xl:max-w-5xl mx-auto">
        <p className="pt-44 max-w-[537px] mx-auto lg:max-w-[595px] 2xl:max-w-[800px] text-[#111111] text-[28px] lg:text-5xl 2xl:text-5xl font-semibold leading-12 lg:leading-14 2xl:leading-[64px] bricolage-grotesque-font text-center">
          Accédez à des{" "}
          <span className="bg-gradient-to-r from-[#FBC570] via-[#FBC570] to-[#FBC570] inline-block text-transparent bg-clip-text">
            offres exclusives
          </span>{" "}
